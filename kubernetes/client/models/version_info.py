...
class TestToDict():
    ...
    def reset_branches(self):
        self.branch_coverage["first"] = False
        self.branch_coverage["second"] = False
        self.branch_coverage["third"] = False
        self.branch_coverage["fourth"] = False
...
class VersionInfo(object):
    ...
    def __init__(self, build_date=None, compiler=None, git_commit=None, git_tree_state=None, git_version=None, go_version=None, major=None, minor=None, platform=None, local_vars_configuration=None):  # noqa: E501
        ...
        TestToDict.reset_branches(TestToDict)
