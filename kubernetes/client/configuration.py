...
class TestGetApiWithKey(Exception):
    __test__ = False
    ...
    def reset_branches(self):
        self.branch_coverage["hook"] = False
        self.branch_coverage["key"] = False
        self.branch_coverage["prefix"] = False
...
class Configuration(object):
    ...
    def get_api_key_with_prefix(self, identifier):
        ...
        if key:
            TestGetApiWithKey.branch_coverage["key"] = True
            prefix = self.api_key_prefix.get(identifier)
            if prefix:
                TestGetApiWithKey.branch_coverage["prefix"] = True
                return "%s %s" % (prefix, key)
            else:
                TestGetApiWithKey.branch_coverage["else"] = True
                return key
    ...
    def to_debug_report(self):
        ...
        return "Python SDK Debug Report:\n"\
               ...
               "SDK Package Version: 30.0.0+snapshot".\
...
config.refresh_api_key_hook = dummy_refresh_api_key_hook  
