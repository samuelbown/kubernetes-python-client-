...
class AdmissionregistrationV1ServiceReference(object):
    ...
    def __init__(self, name=None, namespace=None, path=None, port=None, local_vars_configuration=None):  # noqa: E501
        ...
        if local_vars_configuration is None:
            TestInit.branch_coverage["first"] = True
        ...
        if path is not None:
            TestInit.branch_coverage["second"] = True
            self.path = path
        if port is not None:
            TestInit.branch_coverage["third"] = True
            self.port = port
...
TestInit.print_branches(TestInit)
TestInit.reset_branches(TestInit) 
